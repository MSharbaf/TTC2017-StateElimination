...
public abstract class TestFramework {
	...
	//	tg = getTransitionGraphFromXMI(modelName);
		...
		if(transformationType.equals("fsa2regex")) regex = FSAToRegex(modelName);
		else if(transformationType.equals("dtmc2sre")) regex = DTMCToSRE(modelName);
	 ...
	 */
	public abstract String FSAToRegex(String modelName);
	
	/*
	 * implement this method
	 */
	public abstract String DTMCToSRE(String modelName);
